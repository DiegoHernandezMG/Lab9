...
# Crear el clasificador Euclidiano
classifier = EuclideanClassifier()

# Evaluar el dataset Iris
print("\n*** Iniciando Evaluación del Dataset Iris con Clasificador Euclidiano ***")
...
print("\n*** Iniciando Evaluación del Dataset Wine con Clasificador Euclidiano ***")
...
print("\n*** Iniciando Evaluación del Dataset Breast Cancer con Clasificador Euclidiano ***")
